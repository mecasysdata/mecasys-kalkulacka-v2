...
# --- 5. EKONOMIKA ---
st.subheader("4. Ekonomické výpočty")
cena_material = 0.0
...
st.divider()
st.subheader("📋 Kompletný prehľad všetkých premenných")
vsetky_data = {
    "Kategória": ["Identifikácia", "Identifikácia", "Identifikácia", "Zákazník", "Zákazník", "Zákazník", "Materiál", "Materiál", "Materiál", "Geometria", "Geometria", "Geometria", "Geometria", "Geometria", "Výroba", "Výroba", "Ekonomika", "Ekonomika", "Ekonomika", "Ekonomika", "AI Predikcia"],
    "Premenná": ["Dátum", "Ponuka", "Item", "Zákazník", "Krajina", "Lojalita", "Materiál", "Akosť", "Hustota [kg/m³]", "Priemer d [mm]", "Dĺžka l [mm]", "Plocha prierezu [mm²]", "Plocha plášťa [mm²]", "Hmotnosť kusu [kg]", "Počet kusov", "Náročnosť", "Cena mat. [€/ks]", "Druh kooperácie", "Cena koop. [€/ks]", "Vstupné náklady [€/ks]", "AI Čas M1 [min/ks]"],
    "Hodnota": [datum, ponuka, item, zakaznik, krajina, lojalita, material, akost, hustota, d, l, round(plocha_prierezu, 2), round(plocha_plasta, 2), round(hmotnost, 4), pocet_kusov, narocnost, round(cena_material, 4), vybrany_druh_koop, round(cena_kooperacia, 4), round(vstupne_naklady, 4), f"{round(predikovany_cas_min, 2)} min"]
}
st.table(pd.DataFrame(vsetky_data))
